...
function Header() {
  ...
  return (
    <header>
      <nav className="fixed top-0 left-0 w-full h-auto bg-gray-800 z-10 flex items-center justify-between px-6 py-4">
        {/* Logo */}
        <h3 className="text-white font-bold text-2xl">News Sphere</h3>

        {/* Navigation Links */}
        <ul
          className={
            active
              ? "flex flex-col gap-4 absolute top-16 right-4 bg-gray-700 p-4 rounded-lg"
